...
const NavBar = () => {
  ...
  return (
    <div className="navbar justify-between bg-base-100 dark:bg-gray-900 dark:text-white">
      ...
      <div>
      <NavLink to="/" className="p-2 hover:bg-gray-200 dark:text-gray-50 rounded-full">Home</NavLink>
      <NavLink to="/signin" className="p-2 hover:bg-gray-200 dark:text-gray-50 rounded-full">Sign In</NavLink>
      </div>
      <div className="flex-none flex items-center space-x-4">
        ...
        <div className="dropdown dropdown-end">
          ...
          <div
            tabIndex={0}
            className="card card-compact dropdown-content bg-base-100 dark:bg-gray-800 z-[1] mt-3 w-52 shadow"
          >
